...
namespace DoodleJump.Classes
{
    public static class PlatformController
    {
        ...
        public static void CreateEnemy(Platform platform)
        {
            ...
            {
                case 1:
                    var enemy = new Enemy(new PointF(platform.transform.position.X + (platform.sizeX / 2) - 35, platform.transform.position.Y - 50), enemyType);
                    enemies.Add(enemy);
                    break;
                case 2:
                    enemy = new Enemy(new PointF(platform.transform.position.X + (platform.sizeX / 2) - 30, platform.transform.position.Y - 60), enemyType);
                    enemies.Add(enemy);
                    break;
                case 3:
                    enemy = new Enemy(new PointF(platform.transform.position.X + (platform.sizeX / 2) - 25, platform.transform.position.Y - 40), enemyType);
                    enemies.Add(enemy);
                    break;
